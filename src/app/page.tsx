        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <Image src="/vivk_logo.png" alt="VIVK" width={218} height={75} className="h-[75px] w-auto" priority />
            </div>
          ...
          <div className="grid md:grid-cols-4 gap-10 mb-12">
            <div className="md:col-span-2">
              <div className="flex items-center gap-2 mb-4">
                <Image src="/logo_white.png" alt="VIVK" width={124} height={43} className="h-[43px] w-auto" />
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-sm">
                ...
                <li><Link href="/refund-policy" className="hover:text-white transition-colors">Payment & Refund Policy</Link></li>
